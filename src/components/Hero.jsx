...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    overlayImg.src = '/assets/hero-video/hero-image/hero.png';
    overlayImg.onload = () => {
  ...
  useGSAP(
    () => {
      ...
      const renderReveal = () => {
        if (
          !revealCanvasRef.current ||
          !revealMaskCanvasRef.current ||
          !heroOverlayObj.current
        )
          return;
  ...
  return (
    <section ref={containerRef} className="relative h-[400vh] w-full bg-black">
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        <img
          ref={topLayerRef}
          src="/assets/hero-video/frame_225.jpg"
        ...
        <div className="absolute bottom-0 left-0 w-full z-[10] px-8 md:px-16 pb-12 flex flex-col pointer-events-auto">
          <div className="flex flex-col md:flex-row justify-between items-end w-full mb-8 max-w-[1800px] mx-auto">
            <div className="flex-1 mb-8 md:mb-0">
              ...
              <p
                className="hero-subtitle opacity-0 text-[#ffffff] text-[14px] leading-[1.4] font-light max-w-[200px]"
