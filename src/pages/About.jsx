      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-7 space-y-8 about-content">
          <p className="text-lg md:text-2xl font-light text-[#ffffff] leading-relaxed">
            Engineering robust web, desktop, and machine learning systems with
            precision and high-performance aesthetics.
          </p>
          <p className="text-[rgba(255,255,255,0.6)] text-sm md:text-base font-light leading-relaxed">
            We focus on constructing robust offline-first software solutions,
            intelligent cybersecurity firewalls, and custom full-stack web
            applications. Grounded in strong engineering principles across
            Computer Science and Mechanical engineering disciplines, every
            deliverable balances performance with visual impact.
          </p>
        </div>
        ...
        <div className="lg:col-span-5 space-y-12 about-content">
          <div className="border-t border-[rgba(255,255,255,0.1)] pt-6">
            ...
            <p className="text-sm font-medium tracking-wide">
              React, Electron.js, SQLite, MERN, Python, Machine Learning, MySQL
            </p>
          </div>
          ...
          <div className="border-t border-[rgba(255,255,255,0.1)] pt-6">
            ...
            <p className="text-sm font-medium tracking-wide">
              Desktop Persistence, Cyber Defense, Payload Classification, High-Concurrency Tuning
            </p>
          </div>
